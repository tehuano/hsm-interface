...
class MyView(Frame):
    def loadView(self):
        ...
        label_llave = Label(self.frame,textvariable = self.label_text_llave).grid(row = 1, padx = 10, pady = 5, sticky = W)
    ...
    def __init__(self,vc):
        ...
        self.label_text_llave.set('LLave')
        self.label_text_mensaje = StringVar()
        self.label_text_mensaje.set('Mensaje')
        self.label_text_resultado = StringVar()
        self.label_text_resultado.set('')
        self.loadView()
    def getEntry_text_key(self):
    #returns a string of the entry text
        return self.entry_text_llave.get()
    def getEntry_text_msg(self):
    #returns a string of the entry text
